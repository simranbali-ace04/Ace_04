...
const Navbar = () => {
  return (
    <div className="w-full sm:w-4/5 lg:w-3/5 relative z-20 rounded-xl border border-zinc-800 bg-black/40 text-white p-2 px-6 flex items-center justify-between">
