...
const Navbar = () => {
  ...
  return (
    <div className="w-full sm:w-4/5 lg:w-3/5 relative z-20 rounded-xl border border-zinc-400 dark:border-zinc-800 bg-zinc-50/80 dark:bg-black/40 text-slate-800 dark:text-white p-2 px-6 flex items-center justify-between mt-4 transition-colors duration-300">
