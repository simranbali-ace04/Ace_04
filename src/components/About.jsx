    ...
    <div className="relative z-10 rounded-xl border border-zinc-400 bg-zinc-50/70 dark:border-zinc-800 dark:bg-black/50 dark:text-white transition-colors px-8 py-4 m-3">
      ...
      <div className="text-md m-4 flex flex-col gap-3 text-slate-800 dark:text-olive-200 transition-colors duration-300">
        <h1>
          ...
          , a Computer Science student who enjoys building things that solve
          real problems and make life a little easier. I love turning ideas into
          projects, exploring new technologies, and learning by building along
          the way. I'm still figuring things out, making mistakes, and growing
          every day and honestly, that's part of the fun.
        </h1>
        <h1>
          I enjoy participating in{" "}
          <span className="text-rose-600 dark:text-rose-500">hackathons</span> ,
          meeting people who share the same passion for tech, and building under
          pressure. As a{" "}
          <span className="text-rose-600 dark:text-rose-500">co-founder</span>{" "}
          and{" "}
          <span className="text-rose-600 dark:text-rose-500">Tech Head</span> of
          my college's tech society, I love creating spaces where people can
          learn, connect, and grow together. Outside of tech, you'll usually
          find me listening to music, swimming , cycling, sketching, or planning
          my next big goal.
        </h1>
      </div>
      <div className="mt-6 border-t border-zinc-300 dark:border-zinc-800 pt-5 transition-colors duration-300">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          <div className="flex items-center gap-3 lg:border-r border-zinc-300 dark:border-zinc-800 lg:pr-6 transition-colors duration-300">
            ...
            />
            <p className="text-sm text-slate-700 dark:text-olive-200">
